...
class AdminCouponCrudFixture extends BaseFixture {
  private readonly businessModel: Model<BusinessModel> = this.application.get('BusinessModel');
  private readonly collectionModel: Model<CouponModel> = this.application.get('CouponModel');

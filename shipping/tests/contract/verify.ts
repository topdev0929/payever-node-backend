...
import { asyncProviderChecker, PactAsyncMessagesCollector, PactBootstrap } from '@pe/pact-kit';
...
describe('Pact Verification', () => {
  ...
  it(`should validate the expectations of all consumers for messages`, (done: (err?: any) => void) => {

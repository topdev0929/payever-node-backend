...
import { ImportFailedProvider, ProductImportedProvider } from '../providers';
import { ImportSuccessProvider } from '../providers/import-success.provider';
...
export const pactConfiguration: PactConfigurationInterface = {
  ...
  options: {
    ...
    rabbitMessagesProviders: [
      ProductImportedProvider,
      ImportFailedProvider,
      ImportSuccessProvider,
    ],
  },
  pactBroker: {
    consumerVersion: env.PACT_CONSUMER_VERSION,

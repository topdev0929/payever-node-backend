...
@Voter()
@Injectable()
export class PlanCustomerSubscriptionDelete extends AbstractVoter {
  public static readonly DELETE: string = 'delete';

  protected async supports(attribute: string, subject: any): Promise<boolean> {
    return attribute === PlanCustomerSubscriptionDelete.DELETE && PlanCustomerSubscriptionDelete.isPlan(subject);
  }

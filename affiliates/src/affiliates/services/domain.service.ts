...
import { AffiliateBrandingModel, DomainModel } from '../models';
...
export class DomainService {
  ...
  public async findByBranding(id: string): Promise<DomainModel[]> {
    return this.domainModel.find({
      affiliateBranding: id,
    });
  }
  ...
  public async deleteAllByBrandingId(id: string): Promise<void> {

...
export const BusinessMonthAmountSchema: Schema = new Schema(
  {
    _id: { type: String, default: uuid },
    amount: { type: Schema.Types.Decimal128, required: true, get: (value: any) => DecimalGetter.get(value) },
    businessId: { type: Schema.Types.String, required: true, ref: MongooseModel.Business },
...
BusinessMonthAmountSchema.virtual('business', {
  foreignField: '_id',
  justOne: true,

...
export class EcomRateAmongVisitorsWidget {
  public static buildWidget(
    ...
    return [
      this.shopEcomRateAmongVisitors(business._id, shop, dates),
      this.posEcomRateAmongVisitors(business._id, terminal, dates),
      this.siteEcomRateAmongVisitors(business._id, site, dates),
    ];
  }

  private static shopEcomRateAmongVisitors(businessId: string, shop: ShopModel, dates: DateDefaultInterface): any {
    const widgetSettings: any[] = [
      [
        ...
        [
          {
            'type': 'text',
            'value': 'Ecom Rate Among Visitors',
          },
        ],
      ],
      [
        [
          {
            'type': 'metric',
            'value': MetricEnum.EcomRateAmongVisitors,
          },
          {
            'type': 'dateTimeFrom',
  ...
  private static posEcomRateAmongVisitors(
    businessId: string,
    terminal: TerminalModel,
    dates: DateDefaultInterface,
  ): any {
  ...
  private static siteEcomRateAmongVisitors(businessId: string, site: SiteModel, dates: DateDefaultInterface): any {
    const widgetSettings: any[] = [
      [
        [
          {

...
export class TotalCountAllClicksWidget {
  public static buildWidget(
    ...
    return [
      this.shopTotalCountAllClicks(business._id, shop, dates),
      this.posTotalCountAllClicks(business._id, terminal, dates),
      this.siteTotalCountAllClicks(business._id, site, dates),
    ];
  }

  private static shopTotalCountAllClicks(businessId: string, shop: ShopModel, dates: DateDefaultInterface): any {
    const widgetSettings: any[] = [
      [
        ...
        [
          {
            'type': 'text',
            'value': 'Total Count Of All Clicks',
          },
        ],
      ],
      [
        [
          {
            'type': 'metric',
            'value': MetricEnum.TotalCountOfAllClicks,
          },
          {
            'type': 'dateTimeFrom',
  ...
  private static posTotalCountAllClicks(
    businessId: string,
    terminal: TerminalModel,
    dates: DateDefaultInterface,
  ): any {
  ...
  private static siteTotalCountAllClicks(businessId: string, site: SiteModel, dates: DateDefaultInterface): any {
    const widgetSettings: any[] = [
      [
        [
          {

Feature: Ws delete message
  ...
  Scenario: Delete message for everyone
  ...
  Scenario: Delete message only for me: already deleted
    Given I use DB fixture "messages"
    When I emit socket-io event "messages.ws-client.message.delete" with json:
      """
      {
  ...
  Scenario: Delete message for every one: I'm not sender of message
    Given I use DB fixture "messages"
    When I emit socket-io event "messages.ws-client.message.delete" with json:
      """
      {
  ...
  Scenario: Delete message only for me: I'm not sender of message
    Given I use DB fixture "messages"
    When I emit socket-io event "messages.ws-client.message.delete" with json:
      """
      {

...
export class BusinessExistsHasAmazonAndConnectedWithExternalIdState extends AbstractStateFixture {
  ...
  public getStateName(): string {
    return 'Business exists, has amazon subscription and connected with external id';
  }
}

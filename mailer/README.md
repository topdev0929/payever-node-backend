...
Run `npm start:dev` for a dev server. Server will be started at `http://localhost:3060/`. The app will automatically rebuild if you change any of the source files.

...
export class addSantanderDeRefundTemplate extends BaseMigration {
  public async up(): Promise<void> {

    const templatesToUpdate: EmailTemplatesType[] = emailTemplates.filter(
      (item: EmailTemplatesType) => [
        'santander_de.payment_action.refund',
  ...
  public description(): string {
    return 'Add Santander DE refund template'
  };

  public migrationName(): string {
    return 'addSantanderDeRefundTemplate'
  }

...
export class UpdateDkPaymentSignedEmailTemplate extends BaseMigration {
  ...
  public description(): string {
    return 'update Dk payment signed email template'
  };

  public migrationName(): string {
    return 'UpdateDkPaymentSignedEmailTemplate'
  }

Feature: User media features
  ...
  Scenario: Delete many user media
    When I send a POST request to "/api/{{businessId}}/medias/delete" with json:
      """
      {
        "ids": [
          "{{userMediaId}}",
  ...
  Scenario: Add album to many user media
    When I send a POST request to "/api/{{businessId}}/medias/add/album/{{albumId1Lvl0}}" with json:
      """
      {
        "ids": [
          "{{userMediaId}}",
  ...
  Scenario: remove album from many user media
    When I send a POST request to "/api/{{businessId}}/medias/remove/album" with json:
      """
      {
        "ids": [
          "{{userMediaId}}",

...
export class VideoSubscriptionMediaInfoStrategy implements MediaInfoTaskStrategyInterface {
  ...
  public async runTask(
    ...
    this.logger.log('Processing Video Subscription Media Info Task ...');

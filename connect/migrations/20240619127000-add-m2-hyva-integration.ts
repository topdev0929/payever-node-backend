...
const integrationName: string = 'magento_hyva';
export class UpdateMagentoHyvaIntegrationsMigration extends BaseMigration {
  ...
  public description(): string {
    return 'Update magento hyve migration';
  };

  public migrationName(): string {
    return 'UpdateMagentoHyvaIntegrationsMigration';
  };

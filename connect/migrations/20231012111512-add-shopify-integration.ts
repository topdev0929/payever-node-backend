...
const integrationName: string = 'shopify-design';
export class AddShopifyIntegrationsMigration extends BaseMigration {
  ...
  public description(): string {
    return 'Add shopify design migration';
  };

  public migrationName(): string {
    return 'AddShopifyDesignIntegrationsMigration';
  };
  ...
  private getServiceUrl(identifier: string): string {
    ...
    let matches: string[] | null = regex.exec(url);

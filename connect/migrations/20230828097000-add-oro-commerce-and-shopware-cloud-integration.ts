...
const integrationNames: string[] = ['oro_commerce', 'shopware_cloud'];
export class AddOroCommerceAndShopwareCloudIntegrationsMigration extends BaseMigration {

  public async up(): Promise<void> {

    const fixtures: any[] = integrationsFixture.filter((integration: any) => {
      return integrationNames.includes(integration.name);
    });
  ...
  public migrationName(): string {
    return 'AddOroCommerceAndShopWareCloudIntegrationsMigration';
  };

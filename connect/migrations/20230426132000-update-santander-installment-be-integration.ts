...
export class UpdateSantanderBeIntegrationsMigration extends BaseMigration {

  public async up(): Promise<void> {

    const fixtures: any[] = integrationsFixture.filter((integration: any) => {
      return ['santander_installment_be'].includes(integration.name);
    });
  ...
  public description(): string {
    return 'Update Santander BE integrations migration';
  };

  public migrationName(): string {
    return 'UpdateSantanderBeIntegrationsMigration';
  };

...
const integrationName: string = 'figma';
export class AddFigmaIntegrationsMigration extends BaseMigration {
  ...
  public description(): string {
    return 'Add figma migration';
  };

  public migrationName(): string {
    return 'AddFigmaIntegrationsMigration';
  };

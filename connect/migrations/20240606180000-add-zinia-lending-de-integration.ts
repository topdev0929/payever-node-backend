...
export class AddZiniaLendingIntegrationsMigration extends BaseMigration {

  public async up(): Promise<void> {

    const fixtures: any[] = integrationsFixture.filter((integration: any) => {
      return ['zinia_pos_lending_de', 'zinia_lending_de'].includes(integration.name);
    });
  ...
  public description(): string {
    return 'Add Zinia Lending DE integrations migration';
  };

  public migrationName(): string {
    return 'AddZiniaLendingIntegrationsMigration';
  };

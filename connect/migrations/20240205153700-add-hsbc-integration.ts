...
export class AddHSBCIntegrationMigration extends BaseMigration {

  public async up(): Promise<void> {

    const fixtures: any[] = integrationsFixture.filter((integration: any) => {
      return ['hsbc'].includes(integration.name);
    });
  ...
  public description(): string {
    return 'Add HSBC integration migration';
  };

  public migrationName(): string {
    return 'AddHSBCIntegrationMigration';
  };

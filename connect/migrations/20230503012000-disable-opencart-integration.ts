...
const integrationName: string = 'opencart';
export class UpdateOpenCartIntegrationsMigration extends BaseMigration {
  ...
  public description(): string {
    return 'Update opencart migration';
  };

  public migrationName(): string {
    return 'UpdateOpenCartIntegrationsMigration';
  };

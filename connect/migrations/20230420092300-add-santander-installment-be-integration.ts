...
export class AddSantanderBeIntegrationsMigration extends BaseMigration {
  ...
  public description(): string {
    return 'Add Santander BE integrations migration';
  };
  
  public migrationName(): string {
    return 'AddSantanderBeIntegrationsMigration';
  };

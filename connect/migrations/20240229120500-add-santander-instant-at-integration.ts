...
export class AddSantanderInstantATIntegrationMigration extends BaseMigration {

  public async up(): Promise<void> {

    const fixtures: any[] = integrationsFixture.filter((integration: any) => {
      return ['santander_instant_at'].includes(integration.name);
    });
  ...
  public description(): string {
    return 'Add Santander Instant AT integration migration';
  };

  public migrationName(): string {
    return 'AddSantanderInstantATIntegrationMigration';
  };

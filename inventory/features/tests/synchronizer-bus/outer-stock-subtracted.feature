Feature: When received message "synchronizer.event.outer-stock.subtracted" should subtract stock to inventory
  Background:
  ...
  Scenario: Receive "synchronizer.event.outer-stock.subtracted" message
    Given I use DB fixture "synchronizer-bus/outer-stock-subtracted"

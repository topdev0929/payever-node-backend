...
const DEFAULT_SITE_ID: string = 'cccccccc-cccc-cccc-cccc-cccccccccccc';

class CreateSiteDefaultExistsFixture extends BaseFixture {
...
export = CreateSiteDefaultExistsFixture;

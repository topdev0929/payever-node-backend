Feature: Admin update sites access config
  Background:
  ...
  Scenario: Only admin role has access to admin endpoint
    Given I authenticate as a user with the following data:
      ...
      """
    When I send a GET request to "/api/admin/sites/access"
  ...
  Scenario: Update site config, change isLive status
    ...
    Given I mock Elasticsearch method "singleIndex" with:
      ...
      """
    When I send a PATCH request to "/api/admin/sites/access/{{siteId}}" with json:
      """
      {

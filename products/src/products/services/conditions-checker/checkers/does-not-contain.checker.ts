...
export class DoesNotContainChecker implements CheckerInterface {
  public doesSupport(filter: FilterInterface): boolean {
    return FilterFieldTypeEnum.String === filter.fieldType
      && filter.fieldCondition === StringFieldConditionEnum.Contains;
  }
  ...
  public async doesSatisfy(
    ...
    return regexp.test(ValueExtractorHelper.getValueByPath(filter.field, product)) !== true;
  }
}

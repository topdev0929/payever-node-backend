Feature: Channel set API
  ...
  Scenario: Activate already activated channel set with same type
    Given I use DB fixture "channel-set/channel-set-bus-message/existing-channel-sets-one-is-active-same-type"
  ...
  Scenario: Activate channel set among other channel set with same type
    Given I use DB fixture "channel-set/channel-set-bus-message/existing-channel-sets-one-is-active-same-type"
    When I publish in RabbitMQ channel "async_events_products_micro" message with json:
      """
      {
  ...
  Scenario: Activate channel set among others inactive types
    Given I use DB fixture "channel-set/channel-set-bus-message/existing-channel-sets-three-different-types"
    When I publish in RabbitMQ channel "async_events_products_micro" message with json:
      """
      {
        "name": "channels.event.channel-set.activated",
  ...
  Scenario: Activate channel set among multiple channel set that already active
    Given I use DB fixture "channel-set/channel-set-bus-message/existing-channel-sets-one-is-active-multiple-types"
    When I publish in RabbitMQ channel "async_events_products_micro" message with json:
      """
      {
        "name": "channels.event.channel-set.activated",
  ...
  Scenario: No business
    Given I use DB fixture "channel-set/channel-set-bus-message/no-business"
    When I publish in RabbitMQ channel "async_events_products_micro" message with json:
      """
      {
        "name": "channels.event.channel-set.activated",
      ...
      """
    And process messages from RabbitMQ "async_events_products_micro" channel
    Then model "ChannelSet" with id "{{channelSetIdPosOne}}" should not exist

...
import { RabbitChannel } from '../notifications/enums/rabbit-channel.enum';
    ...
    exchanges: [
      {
        ...
        queues: [
          {
            name: RabbitChannel.Notifications,
            options: {
              deadLetterExchange: 'async_events_fallback',
              deadLetterRoutingKey: RabbitChannel.Notifications,
              durable: true,
            },
          },
          {
            name: RabbitChannel.NotificationsNotify,
            options: {
              deadLetterExchange: 'async_events_fallback',
              deadLetterRoutingKey: RabbitChannel.NotificationsNotify,
              durable: true,
            },
          },
        ],

...
export class AddPosSantanderNOIntegrationMigration extends BaseMigration {
  ...
  public async up(): Promise<void> {
    const fixture: any =
      integrationsFixture.find((integration: any) => integration.name === 'zinia_pos');
  ...
  public description(): string {
    return 'Adds POS Openbank integration if not exists';
  }

  public migrationName(): string {
    return 'AddPosOpenbankIntegrationMigration';
  }

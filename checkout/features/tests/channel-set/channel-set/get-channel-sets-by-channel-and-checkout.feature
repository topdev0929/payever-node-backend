Feature: Channel set API
  ...
  Scenario: Get all by checkout and type
    Given I use DB fixture "channel-set/channel-set/by-channel-and-checkout"
    When I send a GET request to "/api/business/{{businessId}}/channelSet/type/shop/checkout/{{checkoutId}}"
  ...
  Scenario: Get all by checkout and type, permission

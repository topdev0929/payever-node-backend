Feature: Channel set API
  ...
  Scenario: Create event first, checkout assign second
    Given I use DB fixture "channel-set/channel-set-bus-message/channel-set.race-condition/no-channel-sets-existing-checkout"
  ...
  Scenario: Checkout assign first, create event second
    Given I use DB fixture "channel-set/channel-set-bus-message/channel-set.race-condition/no-channel-sets-existing-checkout"
    When I publish in RabbitMQ channel "async_events_checkout_app_micro" message with json:
      """
      {

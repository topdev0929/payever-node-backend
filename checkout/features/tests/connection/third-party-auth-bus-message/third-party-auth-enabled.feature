Feature: Connection API
  ...
  Scenario: Business Subscription of Payment Integration Installed
    ...
    Given I remember as "checkoutIdTwo" following value:
      ...
      """
    Given I use DB fixture "connection/third-party-auth-bus-message/third-party-auth-enabled/integration-of-payments-installed"
    ...
    Then model "Connection" with id "{{connectionId}}" should contain json:
      """
      {
        "_id": "{{connectionId}}",
  ...
  Scenario: Business Subscription of Shipping Integration Installed
    ...
    Given I remember as "checkoutIdTwo" following value:
      ...
      "184a8e77-ee1a-48de-b3d2-8d49b19f5054"
      """
    Given I use DB fixture "connection/third-party-auth-bus-message/third-party-auth-enabled/integration-of-shippings-installed"
    When I publish in RabbitMQ channel "async_events_checkout_app_micro" message with json:
      """
      {
        "name": "third-party.event.third-party.connected",
  ...
  Scenario: Business Subscription of Payment Integration Not Installed
    Given I use DB fixture "connection/third-party-auth-bus-message/third-party-auth-enabled/integration-not-installed"
    When I publish in RabbitMQ channel "async_events_checkout_app_micro" message with json:
      """
      {
        "name": "third-party.event.third-party.connected",

Feature: Connection API
  ...
  Scenario: Many Checkout Connections, Different integrations
    ...
    When I send a GET request to "/api/business/{{businessId}}/checkout/{{checkoutId}}/connection"
  ...
  Scenario: Many Checkout Connections, Same integration
    Given I use DB fixture "connection/checkout-connection/get-all/many-connections-same-integration"
    When I send a GET request to "/api/business/{{businessId}}/checkout/{{checkoutId}}/connection"
    Then print last response
    Then print database connection url
    And the response status code should be 200
  ...
  Scenario: Not existing checkout
    Given I use DB fixture "connection/checkout-connection/get-all/many-connections-different-integrations"
    When I send a GET request to "/api/business/{{businessId}}/checkout/not-existing-checkout/connection"
    Then print last response
    Then print database connection url
  ...
  Scenario: Wrong business permission
    Given I use DB fixture "connection/checkout-connection/get-all/many-connections-different-integrations"
    When I send a GET request to "/api/business/wrong-business/checkout/{{checkoutId}}/connection"
    Then print last response
    Then print database connection url

Feature: Payment action
  ...
  Scenario: Execute payment refund action
    ...
    """
    When I send a POST request to "/api/v3/payment/refund/9a8521e181fa3de1127141aa3653b622" with json:
    """
    {
      "amount": 100
    }
  ...
  Scenario: Execute payment cancel action
    ...
    """
    When I send a POST request to "/api/v3/payment/cancel/9a8521e181fa3de1127141aa3653b622"
    Then print last response
    And the response status code should be 201
    And the response should contain json:
    """
  ...
  Scenario: Execute payment edit action
    ...
    """
    When I send a POST request to "/api/v3/payment/edit/9a8521e181fa3de1127141aa3653b622" with json:
    """
    {
      "amount": 400,
      "delivery_fee": 10
  ...
  Scenario: Execute payment shipping goods action
    ...
    """
    When I send a POST request to "/api/v3/payment/shipping-goods/9a8521e181fa3de1127141aa3653b622"
    Then print last response
    And the response status code should be 201
    And the response should contain json:
    """
  ...
  Scenario: Execute payment shipping goods action with payment items
    ...
    """
    When I send a POST request to "/api/v3/payment/shipping-goods/9a8521e181fa3de1127141aa3653b622" with json:
    """
    {
      "amount": 300,
      "payment_items": [
  ...
  Scenario: Execute cancel claim via standalone endpoint
    Given I use DB fixture "legacy-api/payments"
    And I authenticate as a user with the following data:
    """
    {
    ...
    """
    {
      "request": {
        "method": "post",
        "url": "*/api/business/{{businessId}}/3b864596-ca5b-429b-bfc1-4f9d5d87c375/legacy-api-action/claim_cancel"
      },
      "response": {
        "status": 200,
        "body": {
    ...
    """
    When I send a DELETE request to "/api/v3/payment/claim/9a8521e181fa3de1127141aa3653b622"
    Then print last response

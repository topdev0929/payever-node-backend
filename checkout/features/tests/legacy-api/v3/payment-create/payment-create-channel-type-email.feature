      ...
      [
        {
          ...
          "payload": {
            "locale": "en",
            "subject": "Payment of 200 to Business*",
            "templateName": "checkout.finalize_payment",
            "to": "test@test.com",
            "variables": {
              "businessName": "Business*",
              "orderId": "as54a5sd45as4d",
              "redirectUrl": "https://checkout-wrapper-frontend.devpayever.com/en/pay/api-call/*?channelSetId=dbd1a237-a55e-419a-b582-ae3b22e161dc"
            }
          }
        }
      ]

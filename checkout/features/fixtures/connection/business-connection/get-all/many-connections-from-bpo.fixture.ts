...
class TestFixture extends BaseFixture {
  ...
  public async apply(): Promise<void> {
    ...
    const inactive: ConnectionModel = await this.createConnection(business, integrationOne, connectionIdOne);
    await this.setBpoInactive(inactive);

    await this.createConnection(business, integrationOne, connectionIdThree);

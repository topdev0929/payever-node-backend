...
import { BusinessDetailModel, BusinessModel } from '../../../../../src/business/models';
...
class TestFixture extends BaseFixture {
  ...
  public async apply(): Promise<void> {
    ...
    const integrationOne: IntegrationModel =
      await this.integrationModel.create(IntegrationFactory.createSantanderB2BPaymentIntegration());

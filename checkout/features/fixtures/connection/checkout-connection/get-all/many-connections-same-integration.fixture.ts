...
class TestFixture extends BaseFixture {
  ...
  public async apply(): Promise<void> {
    ...
    const connectionIdThree: string = '76529c11-cb45-6881-4b54-4ca5ce00c79f';
    ...
    const connectionThree: ConnectionModel = await this.createConnection(business, integrationOne, connectionIdThree);
    checkout.connections.push(connectionThree);

...
import { CountryModel, CountrySchemaName, LanguageModel, LanguageSchemaName } from '@pe/common-sdk';
...
import { CountryFactory } from '../../../../fixture-factories/country.factory';

class TestFixture extends BaseFixture {
  private languageModel: Model<LanguageModel> = this.application.get(getModelToken(LanguageSchemaName));
  private countryModel: Model<CountryModel> = this.application.get(getModelToken(CountrySchemaName));
  ...
  public async apply(): Promise<void> {
    ...
    await this.countryModel.create(CountryFactory.createDefaultCountries());

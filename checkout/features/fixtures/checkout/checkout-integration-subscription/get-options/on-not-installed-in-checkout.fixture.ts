...
import { CheckoutIntegrationSubModel, CheckoutModel, CheckoutInterface } from '../../../../../src/checkout';
...
class TestFixture extends BaseFixture {
  ...
  public async apply(): Promise<void> {
    ...
    const checkoutIntegration: string = 'b0a201a7-b01f-40c4-bfd0-339cfb8d0675';

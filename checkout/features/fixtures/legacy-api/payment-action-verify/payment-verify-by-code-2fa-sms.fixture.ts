...
import { TwoFactorTypeEnum, VerifyTypeEnum } from '../../../../src/legacy-api/enum';
...
class PaymentsFixture extends BaseFixture {
  ...
  public async apply(): Promise<void> {
    await this.paymentModel.create({
      ...
      channel: 'api',
      channel_set_id: 'd5e798ac-65a4-4aca-bbf4-9843d5d5773f',
    ...
    await this.apiCallModel.create({
      ...
      verify_two_factor: TwoFactorTypeEnum.sms,
    } as any);

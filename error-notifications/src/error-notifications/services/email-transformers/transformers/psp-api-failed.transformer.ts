...
export class PspApiFailedTransformer extends AbstractTransformer {

  public async notificationErrorToEmailDto(
    aggregateDto: ErrorNotificationAggregateDto,
  ): Promise<ErrorNotificationEmailDto> {
    if (aggregateDto.type !== ErrorNotificationTypesEnum.pspApiFailed) {
      return;
    }
    ...
    return {
      ...
      locale: 'en',
      templateName: EmailTemplateNamesEnum.pspApiFailed,
      variables: {

...
export class RotateStrategy implements ImageCompilerStrategyInterface {
  public readonly type: ImageCompilerEffectEnum = ImageCompilerEffectEnum.ROTATE;
  ...
  public async runTask(
    ...
    await Jimp.read(file).then(async (image: Jimp) => {
      image.rotate(effect.payload.degree);

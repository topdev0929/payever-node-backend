...
export class FlipStrategy implements ImageCompilerStrategyInterface {
  public readonly type: ImageCompilerEffectEnum = ImageCompilerEffectEnum.FLIP;
  ...
  public async runTask(
    ...
    this.logger.log('Flip...');
    await Jimp.read(file).then(async (image: Jimp) => {
      image.flip(effect.payload.horizontal, effect.payload.vertical);

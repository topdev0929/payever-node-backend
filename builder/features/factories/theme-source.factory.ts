...
const defaultFactory: any = (): any => {
  ...
  return ({
    ...
    actions: [
      {
        'id': 'ee9380be-fe41-4672-bb83-432672d5d023',
        'createdAt': '2020-07-01T11:04:22.327Z',
        'targetPageId': '4ee1550b-7387-41e4-a9c6-4dde39572d1c',
        'effects': [
            {
                'type': 'template:init',
                'target': 'templates:11d2c84d-b6b5-4fbf-8e42-f86630a03077',
                'payload': {
            ...
            },
            {
                ...
                'target': 'stylesheets:50fbf6cd-6868-4919-86b9-9cc01c6af6a7',
                'payload': {
            ...
            {
                'type': 'stylesheet:init',
                'target': 'stylesheets:ad4cf08d-9464-47e5-a161-aebe80e5eda6',
                'payload': {
                    '06175df3-a3a6-4bb8-a737-b5b1f650ff6b': {},
                    'cc4db00d-6913-4e67-bce8-b04d59ce0b51': {
                        'backgroundColor': '#333',
            ...
            {
                'type': 'stylesheet:init',
                'target': 'stylesheets:9bab5292-d3cf-415c-bae2-6c2dd4058ad5',
                'payload': {
                    '06175df3-a3a6-4bb8-a737-b5b1f650ff6b': {},
                    'cc4db00d-6913-4e67-bce8-b04d59ce0b51': {
                        'backgroundColor': '#333',
            ...
            },
            {
                ...
                'target': 'contextSchemas:810abecd-49aa-426f-98d9-fd14d353552d',
                'payload': {}
            },
            {
                'type': 'page:init',
                'target': 'pages:4ee1550b-7387-41e4-a9c6-4dde39572d1c',
                'payload': {
            ...
            {
                'type': 'context-schema:init',
                'target': 'contextSchemas:90c0aaaa-8d20-4e8d-bf74-814081d92f73',
                'payload': {
                    '@logo': {
                        'service': 'company',
                        'method': 'getLogo',
...
export class ThemeSourceFactory {

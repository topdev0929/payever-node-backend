...
import { contexts, integrationData, integrationLinks } from '@pe/builder-kit/module/migration-data';
...
export async function up(db: any): Promise<void> {
  ...
  await upsert(shopDb, integrationsLinksCollection, integrationLinks);

...
async function up(db: any): Promise<any> {
  ...
  const paymentNames: string[] = Object.values(OnboardingPaymentNameEnum);

  for (const paymentName of paymentNames) {
    const paymentOnboarding: OnboardingDto = onboardings.find( (item: OnboardingDto) => item.name === paymentName);
    ...
    if (paymentOnboarding) {
      ...
      let fixture: any[];
      switch (paymentName) {
        case OnboardingPaymentNameEnum.santander:
          fixture = PaymentDefaultAppsSantanderFixture;
          break;
        case OnboardingPaymentNameEnum.swedbank:
          fixture = PaymentDefaultAppsSwedbankFixture;
          break;
        case OnboardingPaymentNameEnum.zinia:
          fixture = PaymentDefaultAppsZiniaFixture;
          break;
        case OnboardingPaymentNameEnum.paypal:
          fixture = PaymentDefaultAppsPaypalFixture;
          break;
        case OnboardingPaymentNameEnum.instantPayment:
          fixture = PaymentDefaultAppsInstantPaymentFixture;
          break;
        case OnboardingPaymentNameEnum.sofort:
          fixture = PaymentDefaultAppsSofortFixture;
          break;
        case OnboardingPaymentNameEnum.stripe:
          fixture = PaymentDefaultAppsStripeFixture;
          break;
        case OnboardingPaymentNameEnum.cash:
          fixture = PaymentDefaultAppsCashFixture;
          break;
        case OnboardingPaymentNameEnum.applePay:
          fixture = PaymentDefaultAppsApplePayFixture;
          break;
        case OnboardingPaymentNameEnum.googlePay:
          fixture = PaymentDefaultAppsGooglePayFixture;
          break;
        case OnboardingPaymentNameEnum.payEx:
          fixture = PaymentDefaultAppsPayexFixture;
          break;
      }

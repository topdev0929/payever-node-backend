...
export class SantanderDePosInstallmentMigration extends BaseMigration {
  ...
  public description(): string {
    return 'Update the afterRegistration steps of business onboarding to update checkout styles and sections';
  };

  public migrationName(): string {
    return 'Update business checkout afterRegistration';
  };

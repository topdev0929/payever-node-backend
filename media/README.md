...
Run `npm start:dev` for a dev server. Server will be started at `http://localhost:3030/`. The app will automatically rebuild if you change any of the source files.

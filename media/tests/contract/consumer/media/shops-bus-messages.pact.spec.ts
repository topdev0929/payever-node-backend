import 'mocha';
import { ExpectedMessageDto, asyncConsumerChecker, PePact } from '@pe/pact-kit';
...
const messagePact: MessageConsumerPact = PePact.getMessageConsumer(ProvidersEnum.Shops);

describe('Receive media bus messages from shops', () => {

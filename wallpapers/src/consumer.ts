...
import { RabbitChannelsEnum } from './wallpapers/enum';
...
async function bootstrap(): Promise<void> {
  ...
  if (!queueName) {
    queueName = RabbitChannelsEnum.Wallpapers;
  }
  ...
  app.listen(() => logger.log(`Wallpaper queue: ${queueName} consumer started`, 'NestApplication'));
}

...
import { BUSINESS_ID, CHANNEL_ID, BlogFixtureBase, SITE_ACCESS_CONFIG_ID, BLOG_ID } from './blog.fixture.base';

const ANOTHER_BUSINESS_ID: string = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';

class IssueTokenFixture extends BlogFixtureBase {

...
export class ChannelEventMessagesProducerMock extends AbstractMessageMock {
  ...
  public async mockChannelSetCreated(): Promise<void> {
    ...
    await producer.sendChannelSetCreatedMessage(channelSetModelFake, channelAwareBusinessModelFake, channelModelFake);
  }
  ...
  public async mockChannelSetCreatedByDefault(): Promise<void> {
    ...
    producer.sendChannelSetCreatedByDefault(channelSetModelFake, uuid.v4());
  }
  ...
  public async mockChannelSetNamed(): Promise<void> {
    ...
    producer.sendChannelSetNamedByApplication(channelSetModelFake, 'testName');
  }
  ...
  public async mockChannelSetActivated(): Promise<void> {
    ...
    producer.sendChannelSetActivated(channelSetModelFake, channelAwareBusinessModelFake);
  }
}

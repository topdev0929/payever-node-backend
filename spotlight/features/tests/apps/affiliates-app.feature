Feature: Affiliates
  ...
  Scenario: CRUD
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "affiliate.event.affiliate-program.created",
          "payload": {
            "id": "test-1",
            "business": {
              "id": "{{businessId}}"
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "affiliate.event.affiliate-program.export",
          "payload": {
            "id": "test-2",
            "business": {
              "id": "{{businessId}}"
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "affiliate.event.affiliate-program.updated",
          "payload": {
            "id": "test-1",
            "business": {
              "id": "{{businessId}}"
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "affiliate.event.affiliate-program.removed",
          "payload": {
            "id": "test-1",
             "business": {
              "id": "{{businessId}}"

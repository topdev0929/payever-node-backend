Feature: connect
  ...
  Scenario: CRUD
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "connect.event.integration.subscription.created",
          "payload": {
            "businessId": "{{businessId}}",
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "connect.event.integration.subscription.exported",
          "payload": {
            "businessId": "{{businessId}}",
            "integrationSubscription": {
              "id": "test-2",
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
          "name": "connect.event.integration.subscription.updated",
          "payload": {
            "businessId": "{{businessId}}",
            "integrationSubscription": {
              "id": "test-1",
    ...
    When I publish in RabbitMQ channel "async_events_spotlight_micro" message with json:
        """
        {
        "name": "connect.event.integration.subscription.deleted",
        "payload": {
          "integrationSubscription": "test-1",
          "businessId": "{{businessId}}"
        }
        }
        """
